...
1. **Initiation (Read Rules & History)**: Read `.agents/AGENTS.md` (for coding standards) and [history.md](file:///D:/AI%20Agent/Markdown/gravity-markdown/history.md) (for context) before opening any source code.
